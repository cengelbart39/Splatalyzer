...
final class SpecialStatsTests: XCTestCase {
    ...
    func test_StatHelper_specialDamageDistance_notNil() throws {
        ...
        var dmgDist = StatHelper.specialDamageDistance(ap: ap, specialInfo: data)
        XCTAssertNotNil(dmgDist)
                
        // Reefslider
        data = try TestHelper.getSpecialData(for: .reefslider)
        dmgDist = StatHelper.specialDamageDistance(ap: ap, specialInfo: data)
        XCTAssertNotNil(dmgDist)
    ...
    func test_StatHelper_specialPaintRadius_notNil() throws {
        ...
        // Inkjet
        var data = try TestHelper.getSpecialData(for: .inkjet)
        var paintRadius = StatHelper.specialPaintRadius(ap: ap, specialInfo: data)
        XCTAssertNotNil(paintRadius)
                
        // Reefslider
        data = try TestHelper.getSpecialData(for: .reefslider)
        paintRadius = StatHelper.specialPaintRadius(ap: ap, specialInfo: data)
        XCTAssertNotNil(paintRadius)
    ...
    func test_StatHelper_specialFieldHp_notNil() throws {
        ...
        let fieldHp = StatHelper.specialFieldHp(ap: ap, specialInfo: data)
    ...
    func test_StatHelper_specialFieldHp_nil() throws {
        ...
        var fieldHp = StatHelper.specialFieldHp(ap: ap, specialInfo: data)
        XCTAssertNil(fieldHp)
        
        // Crab Tank
        data = try TestHelper.getSpecialData(for: .crabTank)
        fieldHp = StatHelper.specialFieldHp(ap: ap, specialInfo: data)
        XCTAssertNil(fieldHp)
    ...
    func test_StatHelper_specialDeviceHp_notNil() throws {
        ...
        // Big Bubbler
        let data = try TestHelper.getSpecialData(for: .bigBubbler)
        let deviceHp = StatHelper.specialDeviceHp(ap: ap, specialInfo: data)
    ...
    func test_StatHelper_specialDeviceHp_nil() throws {
        ...
        // Booyah Bomb
        var data = try TestHelper.getSpecialData(for: .booyahBomb)
        var deviceHp = StatHelper.specialDeviceHp(ap: ap, specialInfo: data)
        XCTAssertNil(deviceHp)
        
        // Crab Tank
        data = try TestHelper.getSpecialData(for: .crabTank)
        deviceHp = StatHelper.specialDeviceHp(ap: ap, specialInfo: data)
        XCTAssertNil(deviceHp)
    ...
    func test_StatHelper_specialHookInkConsumption_notNil() throws {
        ...
        let hookConsumption = StatHelper.specialHookInkConsumption(ap: ap, specialInfo: data)
    ...
    func test_StatHelper_specialHookInkConsumption_nil() throws {
        ...
        // Big Bubbler
        var data = try TestHelper.getSpecialData(for: .bigBubbler)
        var hookConsumption = StatHelper.specialHookInkConsumption(ap: ap, specialInfo: data)
        XCTAssertNil(hookConsumption)
                
        // Booyah Bomb
        data = try TestHelper.getSpecialData(for: .booyahBomb)
        hookConsumption = StatHelper.specialHookInkConsumption(ap: ap, specialInfo: data)
        XCTAssertNil(hookConsumption)
    ...
    func test_StatHelper_specialHookInkConsumptionPerSecond_notNil() throws {
        ...
        // Zipcaster
        let data = try TestHelper.getSpecialData(for: .zipcaster)
        let hookConsumption = StatHelper.specialHookInkConsumptionPerSecond(ap: ap, specialInfo: data)
        XCTAssertNotNil(hookConsumption)
    }
    ...
    func test_StatHelper_specialHookInkConsumptionPerSecond_nil() throws {
        ...
        // Big Bubbler
        var data = try TestHelper.getSpecialData(for: .bigBubbler)
        var hookConsumption = StatHelper.specialHookInkConsumptionPerSecond(ap: ap, specialInfo: data)
        XCTAssertNil(hookConsumption)
                
        // Booyah Bomb
        data = try TestHelper.getSpecialData(for: .booyahBomb)
        hookConsumption = StatHelper.specialHookInkConsumptionPerSecond(ap: ap, specialInfo: data)
        XCTAssertNil(hookConsumption)
    ...
    func test_StatHelper_specialReticleRadius_notNil() throws {
        ...
        let radius = StatHelper.specialReticleRadius(ap: ap, specialInfo: data)
    ...
    func test_StatHelper_specialReticleRadius_nil() throws {
        ...
        // Big Bubbler
        var data = try TestHelper.getSpecialData(for: .bigBubbler)
        var radius = StatHelper.specialReticleRadius(ap: ap, specialInfo: data)
        XCTAssertNil(radius)
                
        // Booyah Bomb
        data = try TestHelper.getSpecialData(for: .booyahBomb)
        radius = StatHelper.specialReticleRadius(ap: ap, specialInfo: data)
        XCTAssertNil(radius)
    ...
    func test_StatHelper_specialThrowDistance_notNil() throws {
        ...
        var dist = StatHelper.specialThrowDistance(ap: ap, specialInfo: data)
        XCTAssertNotNil(dist)
        
        // Splattercolor Screen
        data = try TestHelper.getSpecialData(for: .splattercolorScreen)
        dist = StatHelper.specialThrowDistance(ap: ap, specialInfo: data)
        XCTAssertNotNil(dist)
    ...
    func test_StatHelper_specialMoveSpeed_notNil() throws {
        ...
        let speed = StatHelper.specialMoveSpeed(ap: ap, specialInfo: data)
    ...
    func test_StatHelper_specialMoveSpeed_nil() throws {
        ...
        // Big Bubbler
        var data = try TestHelper.getSpecialData(for: .bigBubbler)
        var speed = StatHelper.specialMoveSpeed(ap: ap, specialInfo: data)
        XCTAssertNil(speed)
                
        // Booyah Bomb
        data = try TestHelper.getSpecialData(for: .booyahBomb)
        speed = StatHelper.specialMoveSpeed(ap: ap, specialInfo: data)
        XCTAssertNil(speed)
    ...
    func test_StatHelper_specialMaxRadius_notNil() throws {
        ...
        let radius = StatHelper.specialMaxRadius(ap: ap, specialInfo: data)
        XCTAssertNotNil(radius)
    }
    ...
    func test_StatHelper_specialMaxRadius_nil() throws {
        ...
        // Big Bubbler
        var data = try TestHelper.getSpecialData(for: .bigBubbler)
        var radius = StatHelper.specialMaxRadius(ap: ap, specialInfo: data)
        XCTAssertNil(radius)
                
        // Booyah Bomb
        data = try TestHelper.getSpecialData(for: .booyahBomb)
        radius = StatHelper.specialMaxRadius(ap: ap, specialInfo: data)
        XCTAssertNil(radius)
    ...
    func test_StatHelper_specialRadiusRange_nil() throws {
        ...
        // Big Bubbler
        var data = try TestHelper.getSpecialData(for: .bigBubbler)
        var range = StatHelper.specialRadiusRange(ap: ap, specialInfo: data)
        XCTAssertNil(range)
    ...
    func test_StatHelper_specialPowerUpDuration_notNil() throws {
        ...
        let radius = StatHelper.specialPowerUpDuration(ap: ap, specialInfo: data)
        XCTAssertNotNil(radius)
    }
    ...
    func test_StatHelper_specialPowerUpDuration_nil() throws {
        ...
        // Big Bubbler
        var data = try TestHelper.getSpecialData(for: .bigBubbler)
        var powerUp = StatHelper.specialPowerUpDuration(ap: ap, specialInfo: data)
        XCTAssertNil(powerUp)
                
        // Booyah Bomb
        data = try TestHelper.getSpecialData(for: .booyahBomb)
        powerUp = StatHelper.specialPowerUpDuration(ap: ap, specialInfo: data)
        XCTAssertNil(powerUp)
