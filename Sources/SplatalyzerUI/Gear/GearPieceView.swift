...
public struct GearPieceView: View {
    ...
    public var body: some View {
        HStack() {
            ...
            AbilityView(ability: $gearPiece.sub1, isMain: false, restriction: gearPiece.slot)
            
            AbilityView(ability: $gearPiece.sub2, isMain: false, restriction: gearPiece.slot)
            
            AbilityView(ability: $gearPiece.sub3, isMain: false, restriction: gearPiece.slot)
        }
    }
}
