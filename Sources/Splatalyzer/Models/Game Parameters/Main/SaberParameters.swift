...
struct SaberParameters: Codable {
...
extension SaberParameters.BulletParameter {
...
extension SaberParameters.BulletParameter.CollisionParameter {
...
extension SaberParameters.BulletSlashParameter {
    struct DamageParameter: Codable {
...
extension SaberParameters.WeaponParameter {
...
extension SaberParameters.WeaponParameter.SwingParameter {
